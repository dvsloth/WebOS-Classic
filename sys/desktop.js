...
function run(self, input) {
	...
	function launchTab(source, width, height, icon, name) {
		...
		add(`<section class="moveable tab resizable" style="top: ${y}px; left: ${x}px; width: ${width}px; height: ${trueHeight}px;">
			...
			<iframe src="${source}" style="width: ${width-20}px; height: ${trueHeight-20}px;" ></iframe>
		</section>`)
	}
